...
;define sign
(ag_percept (percept_pobj mandatory_right_sign) (percept_pname isa) (percept_pval sign))
...
(ag_percept (percept_pobj mandatory_right_sign) (percept_pname partof) (percept_pval current_road))
