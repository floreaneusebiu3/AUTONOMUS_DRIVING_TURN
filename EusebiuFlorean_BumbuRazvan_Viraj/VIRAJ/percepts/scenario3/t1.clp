...
(ag_percept (percept_pobj event1) (percept_pname isa) (percept_pval event))
...
;define sign
(ag_percept (percept_pobj mandatory_ahead_sign) (percept_pname isa) (percept_pval sign))
...
(ag_percept (percept_pobj mandatory_ahead_sign) (percept_pname partof) (percept_pval current_road))
