...
(ag_percept (percept_pobj parking_screen) (percept_pname available_parking_spaces) (percept_pval zero))
(ag_percept (percept_pobj first_obstacle) (percept_pname distance_from_my_car_to) (percept_pval greater_than_four))
(ag_percept (percept_pobj first_obstacle) (percept_pname type) (percept_pval barrier))
