...
(ag_percept (percept_pobj event2) (percept_pname isa) (percept_pval event))
...
;define pedestrians
(ag_percept (percept_pobj right_pedestrian) (percept_pname isa) (percept_pval pedestrian))
...
(ag_percept (percept_pobj another_car) (percept_pname partof) (percept_pval another_road))
(ag_percept (percept_pobj right_pedestrian) (percept_pname partof) (percept_pval another_road))
...
(ag_percept (percept_pobj my_arrow) (percept_pname direction) (percept_pval right))
